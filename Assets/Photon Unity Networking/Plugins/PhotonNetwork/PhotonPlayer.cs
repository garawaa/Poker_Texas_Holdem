...
public class PhotonPlayer : IComparable<PhotonPlayer>, IComparable<int>, IEquatable<PhotonPlayer>, IEquatable<int>
{
    ...
    public int myChipAmount
    {
        get
        {
            return (int)CustomProperties["myChipAmount"];
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("myChipAmount", value);
    ...
    public int myBetAmount
    {
        get
        {
            return (int)CustomProperties["MyBetAmount"];
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("MyBetAmount", value);
            SetCustomProperties(hash);
        }
    }
    public Hand hand
    {
        get
        {
            return new Hand((string[])CustomProperties["hand"]);
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("hand", value.cards);
            SetCustomProperties(hash);
        }
    }
    public int points
    {
        get
        {
            return (int)CustomProperties["points"];
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("points", value);
            SetCustomProperties(hash);
        }
    }
    public int wins
    {
        get
        {
            return (int)CustomProperties["wins"];
        }
        set
        {
            Hashtable hash = new Hashtable();
    ...
    public int losses
    {
        get
        {
            return (int)CustomProperties["losses"];
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("losses", value);
            SetCustomProperties(hash);
        }
    }
    public bool leftRoom
    {
        get
        {
            return (bool)CustomProperties["leftRoom"];
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("leftRoom", value);
            SetCustomProperties(hash);
        }
    }
    public bool CanTakeTurn
    {
        get
        {
            return (bool)CustomProperties["CanTakeTurn"];
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("CanTakeTurn", value);
            SetCustomProperties(hash);
        }
    }
    public int Avatar
    {
        get
        {
            return (int)CustomProperties["Avatar"];
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("Avatar", value);
            SetCustomProperties(hash);
        }
    }
    public int AvatarGlow
    {
        get
        {
            return (int)CustomProperties["AvatarGlow"];
        }
        set
        {
            Hashtable hash = new Hashtable();
            hash.Add("AvatarGlow", value);
            SetCustomProperties(hash);
        }
    }
